...
\multirow{3}{*}{\begin{tabular}{c}\textbf{Climate/Weather}\\\textbf{Data}\end{tabular}} 
& ECMWF Forecasts 
...
\multirow{3}{*}{\begin{tabular}{c}\textbf{Remote Sensing}\\\textbf{Data}\end{tabular}} 
& SRTM Elevation 
...
\multirow{3}{*}{\begin{tabular}{c}\textbf{Socio-Economic}\\\textbf{Data}\end{tabular}} 
